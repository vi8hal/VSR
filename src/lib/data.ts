...
export const TICKER_TEXT = '⬛ SYSTEM ONLINE // FULLSTACK DEVELOPER // AVAILABLE FOR HIRE // BUILDING THE FUTURE // STACK OVERFLOW SURVIVOR // GREP -R "COFFEE" / // NULL POINTER EXCEPTION IN SOCIAL LIFE // git push --force && pray // THE CLOUD IS JUST SOMEONE ELSE\'S COMPUTER // ⬛';
